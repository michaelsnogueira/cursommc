...
import com.michael.cursomc.domain.Cidade;
import com.michael.cursomc.domain.Cliente;
import com.michael.cursomc.domain.Endereco;
import com.michael.cursomc.domain.Estado;
import com.michael.cursomc.domain.ItemPedido;
import com.michael.cursomc.domain.Pagamento;
import com.michael.cursomc.domain.PagamentoComBoleto;
import com.michael.cursomc.domain.PagamentoComCartao;
...
import com.michael.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestBase() throws ParseException {
		...
		Categoria cat6 = new Categoria(null, "Decorações");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "michaelsnogueira@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "michaellsnogueira@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("23695636", "96859963"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "102", "Sala 800", "Centro", "38777012", cli1, c1);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2122", "Sala 800", "Centro", "38777012", cli2, c2);
